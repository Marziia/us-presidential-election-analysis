...
The logistic regression model used has the following underlying assumptions:
...
7. **Open-ended Questions**:
   - We end by asking open-ended questions around What factors the respondents think most influence the voting decision?

### Data Quality Checks

The survey includes **attention-check questions** and tracks **response time** to flag low-quality responses. In order to reduce noise due to bots filling these up quickly, responses completed in less than **3 minutes** will be excluded.
