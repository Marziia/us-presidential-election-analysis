...
The paper is structured as follows: we begin by describing the dataset and its key variables, after which the model is presented, followed by the results and their implications. In the last part of the paper, we critique the method itself and attempt to abstract some of the learnings into our understanding of the world.
...
**[Google Forms: U.S. Presidential Election Forecast Survey](ADD LINK HERE)**  
